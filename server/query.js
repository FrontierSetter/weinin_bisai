...
exports.create_eagle_trace = function(req, res){
    // console.log(req.query);
    var url="http://yingyan.baidu.com/api/v3/entity/add";
...
exports.add_eagle_trace = function(req, res){
    // console.log(req.query);
...
exports.add_single_eagle_trace = function(req, res){
    // console.log(req.query);
    var url="http://yingyan.baidu.com/api/v3/track/addpoint";
    var requestData=req.query;
    console.log(requestData);
    request({
        url: url,
...
exports.get_eagle_trace = function(req, res){
    // console.log(req.query);
    var url="http://yingyan.baidu.com/api/v3/track/gettrack";
    var requestData=req.query;
    console.log(requestData);
    request({
        url: url,
